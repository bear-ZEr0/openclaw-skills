...
**sop-design 的 13 个阶段必须按顺序全部完成：**

1. 需求捕获 → 2. 结构化解析 → 3. 竞品分析 → 4. 流程确认 → 5. 功能生成 → 
6. 苏格拉底提问 → 7. UI设计 → 8. 技术探索 → 9. 架构设计 → 
10. 可测试性设计 → 11. 风险评估 → 12. 挑战模式 → 13. PRD生成
...
| 某个阶段内容很少 | 也要完整执行流程 |
| 用户急着要结果 | 可以简化，但不能跳过 |
| 技术细节不确定 | 标记 `[待确认]` 继续往下走 |

## 版本历史

| 版本 | 日期 | 变更 |
|------|------|------|
| 1.0.1 | 2026-03-18 | 添加流程完整性规则，Phase 13 增加组装检查清单，Phase 7 增加能力边界说明 |
